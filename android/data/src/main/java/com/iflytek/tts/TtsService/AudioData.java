...
public class AudioData {
	...
	static {
	        mBuffSize = AudioTrack.getMinBufferSize(mSampleRate, AudioFormat.CHANNEL_CONFIGURATION_MONO , AudioFormat.ENCODING_PCM_16BIT) ;
	        if (mBuffSize!= AudioTrack.ERROR_BAD_VALUE  &&  mBuffSize != AudioTrack.ERROR){
	           ...
	           Log.d(TAG," AudioTrack create ok");
	            ...
	            Log.d(TAG," AudioTrack getMinBufferSize erro");
	        }
	}
