...
class ImportDataInfoMIF extends ImportDataInfo {

	ImportDataInfoMIF(long handle, String filePath, FileType fileType,
			String prefixName) {
	...
	public DatasetType getDatasetType() {
		...
		int ugcDatasetType = ImportDataInfoTABNative
	...
	public int getRecordCount() {
		...
		return ImportDataInfoTABNative.jni_GetRecordCount(getHandle());
	}
