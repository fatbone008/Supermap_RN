        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.buttonGroup}>
                    <TouchableHighlight style={styles.geoButton} onPress={this._addPoint}>
                        <Text style={{fontSize:18,color:"white"}}>添加点</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._addPolyLine}>
                        <Text style={{fontSize:18,color:"white"}}>添加线</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._addPolygon}>
                        <Text style={{fontSize:18,color:"white"}}>添加面</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._submit} underlayColor="#002200">
                        <Text style={{fontSize:18,color:"white"}}>提交</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._vertexAdd}>
                        <Text style={{fontSize:18,color:"white"}}>添加节点</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._addPoint}>
                        <Text style={{fontSize:18,color:"white"}}>删除节点</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._addPoint}>
                        <Text style={{fontSize:18,color:"white"}}>编辑节点</Text>
                    </TouchableHighlight>

                    <TouchableHighlight style={styles.geoButton} onPress={this._select}>
                        <Text style={{fontSize:18,color:"white"}}>选择</Text>
                    </TouchableHighlight>
                </View>
            </View>
        );
